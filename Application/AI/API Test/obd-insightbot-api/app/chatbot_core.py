...
DTC_DATABASE = {
  ...
  "P0606": {
    ...
    "possible_causes": [
      "Faulty ECU/PCM",
      "Electrical short or voltage spikes",
      "Software corruption",
  ...
  "P0700": {
    ...
    "recommended_actions": [
      ...
      "Service or repair transmission"
    ],
    "estimated_cost": "£120–£1500"
  },
  ...
  "P0715": {
    ...
    "recommended_actions": [
      "Test turbine speed sensor",
      "Inspect wiring harness",
      "Clean or replace connectors",
      "Replace faulty sensor"
    ],
    "estimated_cost": "£90–£300"
  },
  ...
  "P0730": {
    ...
    "recommended_actions": [
      ...
      "Repair or rebuild transmission if needed"
    ],
  ...
  "P0740": {
    ...
    "recommended_actions": [
      ...
      "Repair transmission components"
    ],
    "estimated_cost": "£150–£1200"
  },
  ...
  "P1101": {
    ...
    "estimated_cost": "£60–£220"
  },

  "P1121": {
    "description": "Throttle Position Sensor Inconsistent with MAF Sensor",
    "severity": "High",
    "possible_causes": [
      "Faulty throttle position sensor",
      "Dirty throttle body",
    ...
    "estimated_cost": "£80–£320"
  },

  "P1155": {
    "description": "Heated Oxygen Sensor Heater Circuit Malfunction (Bank 2 Sensor 1)",
    "severity": "Medium",
    "possible_causes": [
...
class NaturalLanguageResponses:
    ...
    def vehicle_info(car_data):
        ...
        make = car_data['MARK'].title()
        model = car_data['MODEL'].title()
        year = car_data['CAR_YEAR']
        engine = car_data['ENGINE_POWER']
        trans = "manual" if car_data['AUTOMATIC'] == 'n' else "automatic"
