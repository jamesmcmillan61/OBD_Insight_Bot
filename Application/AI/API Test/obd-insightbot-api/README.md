...
A production-ready REST API for the OBD InsightBot chatbot. This API provides natural language automotive diagnostics powered by IBM Granite technology.

## Features

- **Natural Language Processing**: Understands casual questions about your vehicle
- **DTC Code Explanations**: Translates error codes into plain English
...
- **Production Ready**: Health checks, CORS, logging, and error handling
...
To enable the IBM Granite model:
...
Note: The LLM version requires more RAM (4GB minimum) and takes longer to start up.
